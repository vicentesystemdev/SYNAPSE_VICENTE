...
<?php $__env->startSection('content_header'); ?>
    <h1 class="m-0 text-dark">
        <i class="fas fa-fw fa-tachometer-alt text-orange-600"></i> DASHBOARD DEL ADMINISTRADOR
    </h1>
    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div class="card bg-gradient-dark custom-gradient-bg border-0 shadow-lg"> 
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <a href="<?php echo e(route('admin.admins.create')); ?>" class="btn btn-primary custom-btn-orange-outline mr-2">
        ...
        <div class="row">
            <section class="col-lg-7 connectedSortable">
                ...
                <div class="card bg-white custom-card-white shadow-lg"> 
                                ...
                                <li class="item">
                                    <div class="product-img">
                                        <?php
                                            ...
                                            elseif (str_contains($activity->accion_audit, 'evaluacion')) { $icon = 'fa-flag-checkered'; $color = 'text-purple'; }
                                        ?>

      ...
      <div class="relative grid gap-10 md:grid-cols-2 md:items-center">
        ...
        <div class="space-y-4">
          ...
          <div class="flex flex-col gap-3 pt-2 sm:flex-row sm:items-center">
            <a href="<?php echo e(route('estudiante.evaluaciones.adaptativa.siguiente')); ?>"
            ...
            <a href="<?php echo e(route('estudiante.evaluaciones.categorias')); ?>"
        ...
        <div class="relative h-56 md:h-64 lg:h-72">
          ...
          <div
            ...
            <img
              src="<?php echo e(asset('images/hero/adaptativo.png')); ?>"
      ...
      <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
        ...
        <article
          ...
          <div class="p-6 space-y-3">
            ...
            <span
              class="inline-block text-[11px] font-medium px-2 py-1 <?php echo e($nivelLabels[$nivelAlgebra]['color']); ?> rounded">
              Nivel actual: <?php echo e($nivelLabels[$nivelAlgebra]['text']); ?>

            </span>

            <div class="flex justify-end pt-2">
              <a href="<?php echo e(route('estudiante.evaluaciones.por_categoria', 'ALGEBRA')); ?>"
        ...
        <article
          ...
          <div class="p-6 space-y-3">
            ...
            <span
              class="inline-block text-[11px] font-medium px-2 py-1 <?php echo e($nivelLabels[$nivelCalculo]['color']); ?> rounded">
              Nivel actual: <?php echo e($nivelLabels[$nivelCalculo]['text']); ?>

            </span>

            <div class="flex justify-end pt-2">
              <a href="<?php echo e(route('estudiante.evaluaciones.por_categoria', 'CALCULO')); ?>"
        ...
        <article
          ...
          <div class="p-6 space-y-3">
            ...
            <span
              class="inline-block text-[11px] font-medium px-2 py-1 <?php echo e($nivelLabels[$nivelLogica]['color']); ?> rounded">
              Nivel actual: <?php echo e($nivelLabels[$nivelLogica]['text']); ?>

            </span>

            <div class="flex justify-end pt-2">
              <a href="<?php echo e(route('estudiante.evaluaciones.por_categoria', 'LOGICA')); ?>"
        ...
        <article
          ...
          <div class="p-6 space-y-3">
            ...
            <span
              class="inline-block text-[11px] font-medium px-2 py-1 <?php echo e($nivelLabels[$nivelRazon]['color']); ?> rounded">
              Nivel actual: <?php echo e($nivelLabels[$nivelRazon]['text']); ?>

            </span>

            <div class="flex justify-end pt-2">
              <a href="<?php echo e(route('estudiante.evaluaciones.por_categoria', 'RAZON')); ?>"
...
<?php /**PATH C:\laragon\www\synapse\resources\views/estudiante/evaluaciones/index.blade.php ENDPATH**/ ?>
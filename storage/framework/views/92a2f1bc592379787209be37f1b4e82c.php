...
<video autoplay loop muted playsinline id="video-background">
    ...
    <div class="container" id="container">
        <div class="forms-container">
            ...
            <form method="POST" action="<?php echo e(route('password.email')); ?>" id="sign-In">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="input-container">
                    ...
                    <input type="email" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="Ingrese su correo electrónico" required autofocus>
                    <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="line-width-text">
                    <p><a href="<?php echo e(route('login')); ?>">Volver al Inicio de Sesión</a></p>
                </div>
            </form>
        </div>
...
<?php /**PATH C:\laragon\www\synapse\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>
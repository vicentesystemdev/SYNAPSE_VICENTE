                ...
                <div class="footer-content">
                  ...
                  <div class="footer-nav-section">
                    <div class="footer-nav-column">
                      ...
                      <ul class="footer-nav-list">
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.web.info')); ?>">
                        ...
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.crypto.info')); ?>">
                            <div class="footer-nav-link">
                        ...
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.stego.info')); ?>">
                            <div class="footer-nav-link">
                        ...
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.forens.info')); ?>">
                            <div class="footer-nav-link">
                    ...
                    <div class="footer-nav-column">
                      ...
                      <ul class="footer-nav-list">
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.informacion.documentacion')); ?>">
                            <div class="footer-nav-link">
                        ...
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.informacion.manual_estudiante')); ?>">
                            <div class="footer-nav-link">
                        ...
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.informacion.manual_docente')); ?>">
                            <div class="footer-nav-link">
                        ...
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.informacion.politicas_evaluacion')); ?>">
                            <div class="footer-nav-link">
                        ...
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.informacion.preguntas_frecuentes')); ?>">
                            <div class="footer-nav-link">
                    ...
                    <div class="footer-nav-column">
                      ...
                      <ul class="footer-nav-list">
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.informacion.sobre_proyecto')); ?>">
                            <div class="footer-nav-link">
                        ...
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.informacion.proposito_academico')); ?>">
                            <div class="footer-nav-link">
                        ...
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.informacion.modelo_evaluacion_adaptativa')); ?>">
                            <div class="footer-nav-link">
                        ...
                        <li class="footer-nav-item">
                          <a href="<?php echo e(route('estudiante.informacion.metodologia_referencias')); ?>">
                            <div class="footer-nav-link">
...
<?php /**PATH C:\laragon\www\synapse\resources\views/layouts/partials/footer_estudiante.blade.php ENDPATH**/ ?>
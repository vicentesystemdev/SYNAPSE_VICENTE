<?php $__env->startSection('title', 'Dashboard del Docente'); ?>
...
<?php $__env->startSection('sidebar_menu'); ?>
    <?php echo $__env->make('layouts.partials.sidebar_docente', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
<?php $__env->stopSection(); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="card bg-gradient-dark custom-gradient-bg border-0 shadow-lg"> 
                    <div class="card-header border-0 d-flex justify-content-between align-items-center">
                        <h3 class="card-title text-white">
                            <i class="fas fa-chart-pie mr-2 text-orange-400"></i> Visión General del Sistema Synapse CTF
                        </h3>
                        <div class="card-tools">
                            <span class="badge badge-warning custom-badge-warning text-dark"><?php echo e($periodoActual->nombre_per ?? 'Sin período'); ?></span>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="mt-4">
                            <a href="<?php echo e(route('docente.estudiantes.create')); ?>" class="btn btn-primary custom-btn-orange-outline mr-2">
                                <i class="fas fa-user-plus mr-2"></i> Crear Nuevo Estudiante
                            </a>
                            <a href="<?php echo e(route('evaluaciones.create')); ?>" class="btn btn-info custom-btn-teal">
        ...
        <div class="row">
            <div class="col-lg-3 col-6">
                <div class="small-box bg-info custom-small-box-blue shadow-md">
                    ...
                    <a href="<?php echo e(route('docente.estudiantes.index')); ?>" class="small-box-footer">Ver estudiantes <i class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-6">
            ...
            <section class="col-lg-7 connectedSortable">
                ...
                <div class="card bg-dark custom-card-dark shadow-lg">
                    ...
                    <div class="card-footer bg-transparent">
                        <a href="<?php echo e(route('docente.reportes_irt.index')); ?>" class="btn btn-link text-orange-400">Ver Reportes IRT Completos <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\synapse\resources\views/docente/dashboard/index.blade.php ENDPATH**/ ?>
  ...
  <body>
            ...
            <div class="navigation-container4">
              <div class="navigation-container5">
                <style>
                  ...
                  50% {opacity: 1;}}
                @keyframes navigation-divider-glow {0%,100% {opacity: 0.5;
                  box-shadow: 0 0 8px var(--color-accent);}
                  50% {opacity: 1;
                  box-shadow: 0 0 16px var(--color-accent), 0 0 24px var(--color-accent);}}
                </style>
              </div>
            </div>
    ...
    <main id="main-content" class="main-content">
        <section class="info-page-section">
            <h2 class="section-title glitch" data-text="Documentación">
                Documentación
            </h2>
            <p>
...
<ul>
    <li>El estudiante inicia un reto</li>
    <li>Envía un intento</li>
    <li>El motor calcula:
        <ul>
            <li>Correctitud</li>
            <li>Tiempo</li>

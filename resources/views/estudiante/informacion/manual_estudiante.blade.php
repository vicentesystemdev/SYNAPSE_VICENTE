...
<html lang="en">
  <head>
    <title>Manual del Estudiante</title>
    <meta charset="utf-8" />
  ...
  <body>
    ...
    <main id="main-content" class="main-content">
        <section class="info-page-section">
            <h2 class="section-title glitch" data-text="Manual del Estudiante">
...
<ul>
    <li>Aciertos: aumentan tu habilidad</li>
    <li>Errores: ajustan tu curva de aprendizaje</li>
    <li>Tiempo: modifica el puntaje adaptativo</li>
    <li>θ: representa tu habilidad real estimada</li>
</ul>

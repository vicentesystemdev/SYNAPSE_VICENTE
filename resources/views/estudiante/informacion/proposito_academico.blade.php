...
<html lang="en">
  <head>
    <title>Propósito Acadulario</title>
    <meta charset="utf-8" />
  ...
  <body>
    ...
    <main id="main-content" class="main-content">
        <section class="info-page-section">
            <h2 class="section-title glitch" data-text="Propósito Académico">
                Propósito Académico
            </h2>
            <h3>Aprendizaje Basado en Retos</h3>
<p>
    El sistema prepara a estudiantes para entornos reales mediante escenarios auténticos.
</p>
...
<h3>Uso en aulas</h3>
<p>
    Facilita evaluaciones objetivas sin sesgos.
</p>
        </section>
    </main>

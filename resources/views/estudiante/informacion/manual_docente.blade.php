...
<html lang="en">
  <head>
    <title>Manual del Docente</title>
    <meta charset="utf-8" />
  ...
  <body>
    ...
    <main id="main-content" class="main-content">
        <section class="info-page-section">
            <h2 class="section-title glitch" data-text="Manual del Docente">
                Manual del Docente
            </h2>
            <h3>Gestión de Usuarios</h3>
<p>
    Los docentes pueden administrar estudiantes, docentes y administradores desde el panel de control.
</p>
<h3>Supervisión de Evaluaciones</h3>
<ul>
    <li>Activar/desactivar evaluaciones</li>
    <li>Revisar evolución por estudiante</li>
    <li>Confirmar integridad de intentos</li>
</ul>
<h3>Interpretación de IRT</h3>
<p>
    El modelo IRT 2PL calcula:
</p>
<ul>
    <li>b: dificultad del ítem</li>
    <li>a: poder discriminativo</li>
    <li>θ: habilidad del estudiante</li>
</ul>

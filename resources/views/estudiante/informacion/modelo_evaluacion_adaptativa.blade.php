...
<html lang="en">
  <head>
    <title>Modelo de Evaluación Adaptativa</title>
    <meta charset="utf-8" />
  ...
  <body>
            ...
            <div class="navigation-container4">
              <div class="navigation-container5">
                <style>
                  ...
                  @keyframes navigation-divider-glow {
                    0%, 100% { opacity: 0.5; box-shadow: 0 0 8px var(--color-accent); }
                    50% { opacity: 1; box-shadow: 0 0 16px var(--color-accent), 0 0 24px color-mix(in srgb, var(--color-accent) 50%, transparent); }
                  }
                </style>
              </div>
            </div>
    ...
    <main id="main-content" class="main-content">
        <section class="info-page-section">
            <h2 class="section-title glitch" data-text="Modelo de Evaluación Adaptativa">
                Modelo de Evaluación Adaptativa
            </h2>
            <h3>IRT 2PL</h3>
<ul>
    <li>Permite estimar la habilidad verdadera del estudiante (θ) considerando:
        <ul>
            <li>discriminación (a)</li>
            <li>dificultad (b)</li>
        </ul>
    </li>
</ul>
...
<ul>
    <li>Controlan la progresión de niveles.</li>
</ul>

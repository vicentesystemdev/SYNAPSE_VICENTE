...
<html lang="en">
  <head>
    <title>Metodología y Referencias</title>
    <meta charset="utf-8" />
  ...
  <body>
    ...
    <main id="main-content" class="main-content">
        <section class="info-page-section">
            <h2 class="section-title glitch" data-text="Metodología y Referencias">
                Metodología y Referencias
            </h2>
            <h3>Fundamentos</h3>
<ul>
    <li>Teoría de Respuesta al Ítem</li>
    <li>Evaluación adaptativa computerizada</li>

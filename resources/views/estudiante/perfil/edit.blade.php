            ...
            <nav id="navigation-unifranz" class="navigation-unifranz">
              <div class="navigation-container">
                ...
                <div class="navigation-links" style="display: none;">
                  <!-- Navigation links hidden on profile page -->
                </div>
            ...
            <div class="section-container">
                <div class="update-profile-container">
                    <div class="profile-card">
                        @include('estudiante.perfil.partials.update-profile-information-form')
                    </div>

                    <div class="profile-card">
                        @include('estudiante.perfil.partials.update-password-form')
            </div>

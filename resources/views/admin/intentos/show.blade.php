...
@section('content_header')
    <div class="d-flex justify-content-between align-items-center">
        ...
        <a href="{{ route('admin.intentos.exportPdfShow', $intento->id_int) }}" class="btn btn-danger">
    ...
    <div class="container-fluid">
        <div class="card">
            ...
            <div class="card-footer">
                <a href="{{ route('admin.intentos.index') }}" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Volver a la Lista</a>
            </div>
        </div>
    </div>
@endsection
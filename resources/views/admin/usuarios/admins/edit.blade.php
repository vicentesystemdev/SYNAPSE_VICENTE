...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Formulario de Edición de Administrador</h3>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.admins.update', $admin->id) }}" method="POST">
                ...
                @include('components.forms.user-fields', ['user' => $admin, 'emailPrefix' => 'both', 'showPassword' => false])
                ...
                <div class="form-group">
                    ...
                    <select name="role" id="role" class="form-control @error('role') is-invalid @enderror" required>
                        ...
                        @foreach ($allowedRoles as $roleName => $roleLabel)
                            @if ($roleName !== $currentRole) {{-- Evitar duplicar si el rol actual ya está en los roles permitidos --}}
                ...
                <button type="submit" class="btn btn-primary"><i class="fas fa-save"></i> Actualizar Administrador</button>

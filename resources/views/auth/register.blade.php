...
<video autoplay loop muted playsinline id="video-background">
    ...
    <div class="container" id="container">
        <div class="forms-container">
            <form method="POST" action="{{ route('register') }}" id="sign-In">
                @csrf
                
                <h2>Registro de Usuario</h2>
                <p>¿Ya estás registrado? <a href="{{ route('login') }}" id="link-sign-up">Iniciar Sesión</a></p>

                <div class="input-container">
                    <label for="name">Nombre(s) Completo:</label>
                    <input type="text" id="name" name="name" value="{{ old('name') }}" oninput="this.value = this.value.toUpperCase().replace(/[^A-ZÑ ]/g, '');" required>
                    @error('name') 
                ...
                <div class="input-container">
                    ...
                    <input type="text" id="app_usu" name="app_usu" value="{{ old('app_usu') }}" oninput="this.value = this.value.toUpperCase().replace(/[^A-ZÑ ]/g, '');" required>
                    @error('app_usu') 
                        <div class="alert-danger">{{ $message }}</div> 
                    @enderror
                </div>
                ...
                <div class="input-container">
                    ...
                    <input type="text" id="apm_usu" name="apm_usu" value="{{ old('apm_usu') }}" oninput="this.value = this.value.toUpperCase().replace(/[^A-ZÑ ]/g, '');" required>
                    @error('apm_usu') 
                        <div class="alert-danger">{{ $message }}</div> 
                    @enderror
                </div>
                ...
                <div class="input-container">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="Ingrese su correo institucional" required>
                    @error('email') 
                        <div class="alert-danger">{{ $message }}</div> 
                    @enderror

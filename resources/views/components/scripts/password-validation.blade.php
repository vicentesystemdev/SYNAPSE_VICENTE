{{-- Componente reutilizable para validación de contraseña
     Parámetros:
     - passwordId: ID del input de password (default: 'password')
     - confirmPasswordId: ID del input de confirmación (default: 'password_confirmation')
--}}
@php

...
<head>
    ...
    <style>
            ...
            /* Tarjetas oscuras personalizadas (dashboards admin/docente) */
            .custom-card-dark {
                background-color: rgba(30, 42, 69, 0.85) !important;
                border: 1px solid rgba(59, 91, 219, 0.3) !important;
                backdrop-filter: blur(8px);
            }
            .custom-card-dark .card-header {
                background-color: rgba(20, 30, 55, 0.9) !important;
                border-bottom: 1px solid rgba(59, 91, 219, 0.25) !important;
            }
            .custom-card-dark .card-body,
            .custom-card-dark .card-footer {
                background-color: transparent !important;
            }
            /* Forzar texto blanco en TODOS los elementos de las card oscuras */
            .custom-card-dark *,
            .custom-card-dark .card-title,
            .custom-card-dark .product-title,
            .custom-card-dark .product-description,
            .custom-card-dark .item,
            .custom-card-dark p,
            .custom-card-dark span:not(.badge),
            .custom-card-dark li,
            .custom-card-dark a.product-title {
                color: #e2e8f0 !important;
            }
            /* Forzar texto blanco globalmente en items de lista del dashboard */
            ...
            /* Garantizar que .text-muted sea visible en fondos oscuros */
            .content-wrapper .text-muted,
            .content-wrapper .text-white-50 {
            ...
            /* Small boxes (tarjetas de métricas AdminLTE) */
            .small-box h3,
            .small-box p,
            ...
            /* Sidebar nav items - texto blanco */
            .nav-sidebar .nav-item .nav-link p,
            .nav-sidebar .nav-item .nav-link i,
            .nav-sidebar .nav-item .nav-link span {
                color: #e2e8f0 !important;
            }
            /* Nav headers del sidebar */
            .nav-header {
